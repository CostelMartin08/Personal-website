...
export const CookiesMessage = () => {
    ...
    return (
        ...
        <section
            ...
            <div className='flex flex-col justify-between gap-4 items-center p-5 h-full'>
                ...
                <div className='flex gap-5'>
                    <button onClick={handleAcceptCookies} className='px-3 py-2 bg-indigo-900 text-white rounded-xl'>Allow</button>
                    <button className='px-3 py-2 bg-gray-600 text-white rounded-xl'>Decline</button>
                </div>
            </div>
...
const Cookies = () => {
    ...
    return (
        <svg className='size-16' version="1.1" id="cookieSvg" x="0px" y="0px" viewBox="0 0 122.88 122.25" xml:space="preserve">
            <g>
